...
# === DEĞİŞİKLİK BURADA ===
# Kendi veritabanı modülümüzden ve worker'dan doğru modülleri import ediyoruz
...
# get_db fonksiyonu artık gerekli değil, doğrudan SessionLocal kullanacağız.

# ... (dosyanın geri kalanı aynı, sadece list_experiments ve get_experiment_details içindeki
# get_db() context manager'ını kaldırıyoruz)
...
# _generate_config_combinations fonksiyonu burada kalabilir
